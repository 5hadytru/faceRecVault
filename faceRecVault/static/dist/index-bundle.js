...
var errorMsg = document.getElementById("span#errorMsg");
var logInBtn = document.querySelector("#logBtn"); // webcam constraints
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            errorMsg.innerHTML = "navigator.getUserMedia.Error:".concat(_context.t0.toString());
...
init(); // Capturing the image then firing the POST request

var context = canvas.getContext('2d');
snap.addEventListener("click", function () {
  // rendering loading animation
  var loader = document.querySelector('.future-loader');
  loader.classList.add('loader'); // drawing webcam image on canvas then converting base64 string to base64 then blob

  document.querySelector('#cutie').style.display = "";
  context.drawImage(video, 0, 0, 640, 480);
  var imgData = canvas.toDataURL('image/jpeg'); // send b64 image to API

  (0,_functions__WEBPACK_IMPORTED_MODULE_0__.createEncoding)(imgData).then(function (response) {
    response.json().then(function (responseObj) {
      (0,_functions__WEBPACK_IMPORTED_MODULE_0__.handleEncodingResponse)(responseObj);
