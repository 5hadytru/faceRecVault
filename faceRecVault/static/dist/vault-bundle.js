...
var createEntryBtn = document.querySelector('#createEntry');
var entryList = document.querySelector('#entryList');
var greeting = document.querySelector('#greeting').innerText;
var username = greeting.slice(14, -1);
var errorMsg = document.querySelector("#errorMsg");
var logOutBtn = document.querySelector('#logBtn'); // Setting up the log out btn (lazy af i know)
...
createEntryBtn.addEventListener('click', function () {
  (0,_functions__WEBPACK_IMPORTED_MODULE_0__.createVaultEntry)(username).then(function (response) {
...
entryList.addEventListener('click', function (event) {
  ...
  if (target.tagName == "BUTTON") {
    if (target.id[0] == "o") {
      ...
      (0,_functions__WEBPACK_IMPORTED_MODULE_0__.deleteVaultEntry)(username, parseInt(target.id.slice(1)));
      var liElement = document.getElementById("li".concat(target.id.slice(1)));
      liElement.remove();
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./src/vault.js");
/******/ 	// This entry module used 'exports' so it can't be inlined
/******/ })()
;
//# sourceMappingURL=vault-bundle.js.map